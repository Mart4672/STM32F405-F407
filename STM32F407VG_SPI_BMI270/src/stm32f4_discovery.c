...
#define __STM32F4_DISCO_BSP_VERSION                                                        \
    ((__STM32F4_DISCO_BSP_VERSION_MAIN << 24) | (__STM32F4_DISCO_BSP_VERSION_SUB1 << 16) | \
     (__STM32F4_DISCO_BSP_VERSION_SUB2 << 8) | (__STM32F4_DISCO_BSP_VERSION_RC))
/**
 * @}
 */
...
/** @defgroup STM32F4_DISCOVERY_LOW_LEVEL_Private_FunctionPrototypes STM32F4 DISCOVERY LOW LEVEL Private
 * FunctionPrototypes
 * @{
 */
/**
 ...
 */
uint32_t BSP_GetVersion(void) { return __STM32F4_DISCO_BSP_VERSION; }
